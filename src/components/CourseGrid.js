              ...
              >
                ...
                <div className="p-5 sm:p-6 flex flex-col flex-1">
                  <div className={`w-12 h-12 sm:w-14 sm:h-14 rounded-2xl bg-gradient-to-br ${
                    course.id === 'clt1' ? 'from-emerald-100 to-teal-100 dark:from-emerald-900/40 dark:to-teal-900/30' :
                    course.id === 'clt2' ? 'from-teal-100 to-cyan-100 dark:from-teal-900/40 dark:to-cyan-900/30' :
                    course.id === 'dip1' ? 'from-cyan-100 to-blue-100 dark:from-cyan-900/40 dark:to-blue-900/30' :
                    'from-blue-100 to-indigo-100 dark:from-blue-900/40 dark:to-indigo-900/30'
                  } flex items-center justify-center mb-4 group-hover:scale-105 transition-transform duration-300" aria-hidden="true">
                    <svg className={`w-7 h-7 ${
                      course.id === 'clt1' ? 'text-emerald-600 dark:text-emerald-400' :
                      course.id === 'clt2' ? 'text-teal-600 dark:text-teal-400' :
                      course.id === 'dip1' ? 'text-cyan-600 dark:text-cyan-400' :
                  ...
                  <button
                    type="button"
                    className={`mt-auto w-full min-h-12 py-3 px-4 rounded-xl font-semibold transition-all duration-200 shadow-sm hover:shadow-md active:scale-[.98] ${
