...
const BottomNav = ({ currentView, onViewChange, user }) => {
  const isAdmin = user?.email?.toLowerCase() === 'kaigwaakram123@gmail.com';
  const navItems = [
